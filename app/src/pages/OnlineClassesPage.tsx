  ...
  return (
    <ContentPage
      ...
      paragraphs={[
        ...
        'Our online classes are one-on-one sessions & group sessions conducted through Zoom / Google Meet (not pre-recorded videos). All study materials are shared online which can be accessed anytime at your convenient time.',
